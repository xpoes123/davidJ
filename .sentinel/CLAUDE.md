...
Auto-maintained by Sentinel's memory system. Last updated: 2026-04-24 07:19 UTC
...
- fetch() without .ok check silently accepts 404/500 responses (confidence: 24)
...
- Test asset paths work before commit (confidence: 22)
...
- Throw descriptive errors with HTTP status codes (confidence: 7)
...
- Always prepend relative paths for assets (img/, css/, js/) (confidence: 22)
