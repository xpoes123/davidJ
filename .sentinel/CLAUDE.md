...
Auto-maintained by Sentinel's memory system. Last updated: 2026-04-26 16:47 UTC
...
- Bare catch blocks hide critical errors from debugging (confidence: 30)
...
- Proactive error handling over silent failures (confidence: 22)
- Code cleanup as part of bug scanning (confidence: 18)
- Match spacing patterns (e.g., 48px margin-top for nav clearance) (confidence: 18)
- Throw descriptive errors with HTTP status codes (confidence: 17)
...
- Always add catch blocks with console.error for fetch calls (confidence: 21)
